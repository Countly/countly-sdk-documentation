...
<a href="https://cdn.jsdelivr.net/npm/countly-sdk-web@latest/lib/countly.min.js" target="_blank" rel="noopener noreferrer">cdn.jsdelivr.net/npm/countly-sdk-web@latest/lib/countly.min.js</a></code></pre>
  ...
  <div class="tab is-hidden">
    <pre class="wysiwyg-code-block"><code class="language-javascript">// 25.4.1 non minified
...
// 25.4.1 minified (JSDelivr or Cloudflare)
<a href="https://cdn.jsdelivr.net/npm/countly-sdk-web@25.4.1/lib/countly.min.js" target="_blank" rel="noopener noreferrer">cdn.jsdelivr.net/npm/countly-sdk-web@25.4.1/lib/countly.min.js</a> 
or
<a href="https://cdnjs.cloudflare.com/ajax/libs/countly-sdk-web/25.4.1/countly.min.js" target="_blank" rel="noopener noreferrer">cdnjs.cloudflare.com/ajax/libs/countly-sdk-web/25.4.1/countly.min.js</a></code></pre>
  </div>
</div>
<p>
...
<ul>
  <li data-list-item-id="e66451b5102a0137bcbcd35d57d5ff688">key - the name of the event (mandatory)</li>
  <li data-list-item-id="e1194e3e5421f3782dd650d8259ab7457">count - number of events (optional) (defaults to 1)</li>
  <li data-list-item-id="e1b55bb7d6adcf433d10878780c3a0245">sum - sum to report with the event (optional)</li>
  <li data-list-item-id="ed71c761f6ac49d54210a5a3d6f2e4ec0">dur - duration expressed in seconds (optional)</li>
  <li data-list-item-id="ea3d60eda610927829c95d38b200a2872">segmentation - an object with key/value pairs (optional)</li>
</ul>
<p>
...
<ul>
  <li data-list-item-id="e89c355d8c257c64522da44670354aa71">Starting a session at the beginning</li>
  <li data-list-item-id="eb10c18d9f3cebdb289f51f79e0a4cba4">Marking the end of a session</li>
</ul>
<p>
...
// or with filtering you can pick and choose which content to show (SDK version 25.4.3)
...
<ul>
  <li data-list-item-id="eefe9271e666209a9bae7be35aa79363b">start</li>
  <li data-list-item-id="e19655f6f7f341f7e870b374d35ec3a59">visit</li>
  <li data-list-item-id="e99c836de751700f87e3104eed7500511">bounce</li>
  <li data-list-item-id="ea8582f207420fc68d3780f9247e14457">end</li>
  <li data-list-item-id="e36355d9e51734273c6e82a8edd380325">name</li>
  <li data-list-item-id="eba66021b4feb2792e23c4fd18c455550">domain</li>
  <li data-list-item-id="ea05190d2a890d642d1140542b2d5162f">view</li>
  <li data-list-item-id="e3808d39f022655232450cea3c15a89b2">segment</li>
  <li data-list-item-id="e390cc190ed7dfe4278db5a0b5c251979">platform</li>
</ul>
<div class="tabs">
  <div class="tabs-menu">
    <span class="tabs-link is-active">Asynchronous</span>
...
<ul>
  <li data-list-item-id="e7de0e165f6ec6c4286160d73d4632434">
    <code>DEVELOPER_SUPPLIED</code>
  </li>
  <li data-list-item-id="ef562962d88855630982b72b52ece510e">
    <code>SDK_GENERATED</code>
  </li>
  <li data-list-item-id="ebf85371e742abf3e349e891250fcc622">
...
<ul>
  <li data-list-item-id="ef0d0a8d2c56cd09cc90e148635c6dc23">
  ...
  <li data-list-item-id="e4b7bea8577d85db777f56fae23b3e5ed">
...
<ul>
  <li data-list-item-id="e983e4603c29771a40aa32eb15f1742ed">
    Multiple users using the same device would be seen as a single user
  </li>
  <li data-list-item-id="e37324c41d1398a92ef4604026dbda6aa">
...
<ul>
  <li data-list-item-id="e7dcd365e6f57d2ed956deeb696d97bc6">
    Adding a login/authentication page and assigning device ID there
  </li>
  <li data-list-item-id="e968b0a8e860c11fb1dd959d72691a441">
...
<ul>
  <li data-list-item-id="e01393f228ae12e5e9f2a8f86d7100c51">
    Country code in the two-letter, ISO standard ("jp", "gr" etc.)
  </li>
  <li data-list-item-id="e2ca1e2f0df58dcfa525573b373378c28">City name ("Kyoto", "Athens" etc.)</li>
  <li data-list-item-id="e6bc465d09b12b8ef26f0bc10041002eb">Your user’s IP address</li>
</ul>
<p>
...
<ul>
  <li data-list-item-id="ea6998dd6eca6b1b4ce1640f3fb00f33a">
...
<ol>
  <li data-list-item-id="e9611ba18f9082924ba09e3877f096014">
    Fetching widget list from the server with 'get_available_feedback_widgets'
  </li>
  <li data-list-item-id="ea8a85a186ca24f5e412febe95ca02edb">
    Fetching one widget's data from that list with 'getFeedbackWidgetData'
  </li>
  <li data-list-item-id="e4e8bc630b21a557982e538aa4de9d79c">
...
<ul>
  ...
  <li data-list-item-id="e4e30a7f63ed3209a225d1c87c0f7840b">
    <strong>queue_size</strong> - the maximum amount of queued requests to store
    (default: 1000)
  </li>
  <li data-list-item-id="ee2d405d464bba30a7f7bd65825d025e9">
  ...
  <li data-list-item-id="ee1ac1ff07ffe69c2d371f7c027fb5474">
  ...
  <li data-list-item-id="ecf2771ca416f43c68a5cb6b2e54d3753">
  ...
  <li data-list-item-id="e3e5f967ace8911099357410941751609">
  ...
  <li data-list-item-id="efce3ebb5f9703aec64765c4a33735953">
  ...
  <li data-list-item-id="e52442a1782092df068f3a29fdde9bb7c">
    <strong>ignore_referrers</strong> - array with referrers to ignore (default:
    none)
  </li>
  <li data-list-item-id="e3ff11e7420941089e9904521a2f18c77">
    <strong>salt</strong> - string salt for checksums (default: none)
  </li>
  <li data-list-item-id="e2960ddd1754a995ae27db0264eb6274b">
  ...
  <li data-list-item-id="e0a400e0c1632fc840ff4bc37a6679d2c">
  ...
  <li data-list-item-id="e3cdcb5038614b9cc57151c7e19c33322">
  ...
  <li data-list-item-id="ea5eafdfc2bdd0abcc96ce3cb69c38f02">
    <strong>use_session_cookie</strong> - use cookies to track sessions (default:
    true)
  </li>
  <li data-list-item-id="eab64c4d3ca5b4a44adbb7a28fa4fdb92">
  ...
  <li data-list-item-id="e4fff3e37c1eb7c4de1c89b5b359d02e9">
  ...
  <li data-list-item-id="e190aa89f207c60f4a6343cd159a8337e">
  ...
  <li data-list-item-id="e47c4a1bffb6b844c2b0085427a47d9a0">
  ...
  <li data-list-item-id="ee8d6b26a2514e1dc5848e432fe3d9216">
...
<ol>
  <li data-list-item-id="e6bb29fb31b2a77404af60497ba3c2c7c">
  ...
  <li data-list-item-id="ef2db194fb4989f0073c187fec54a4f9b">
    Then declare the plugin script before your Google Analytics implementation
    block
  </li>
  <li data-list-item-id="ee95041e81570e40e72136f66216c0d7d">
