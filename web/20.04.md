<p>
  <span style="font-weight:400">This documentation shows how to install the Countly JS tracker and use Countly to track your web page in detail. It applies to the SDK version 20.04.</span>
</p>
<p>
...
<p>
  <strong><span style="font-weight:400">Simply take the device ID value from Countly.device_id&nbsp;and pass it as a URL parameter named&nbsp;cly_device_id&nbsp;as follows:&nbsp;<a href="http://newdomain.com/?cly_device_id=your-user-device-id">http://newdomain.com/?cly_device_id=your-user-device-id.</a></span></strong>
</p>
