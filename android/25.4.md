...
<pre class="wysiwyg-code-block"><code class="language-java java">dependencies {
  implementation 'ly.count.android:sdk:25.4.9'
}</code></pre>
...
<div class="tabs">
  ...
  id "ly.count.android.plugins.upload-symbols" version "25.4.9"
}</code></pre>
  </div>
...
plugins {
  id "ly.count.android.plugins.upload-symbols" version "25.4.9" apply false
}
...
<ul>
  ...
  <li data-list-item-id="eab8653f741bbbae4555905bff76cbeca">
  ...
  <li data-list-item-id="ead64d6b5390d56f93117755cc50fa1af">
