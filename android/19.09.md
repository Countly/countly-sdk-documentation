...
<div class="callout callout--info">
  ...
  <p>
    Countly Android SDK needs a minimum of Android 4.0 (API Level 14).
  </p>
</div>
<div class="callout callout--info">
  <h3 class="callout__title">Older documentation</h3>
  <p>
    To access the documentation for version 19.02, go
    <a href="https://resources.count.ly/docs/android-sdk-pre-1902">here</a>
  </p>
</div>
...
<p>
  Now, add Countly SDK dependency (<strong>use latest SDK version currently available from gradle, not specifically the one shown in the below sample</strong>).
</p>
<pre><code class="java">dependencies {
		compile 'ly.count.android:sdk:19.09'
}</code></pre>
<p>
...
<p>
  ...
  just create 2 packages and put sources from
...
<p>
  ...
  device ID will be transferred (merged) into user profile with device id you specified
  in the following method call:
</p>
<pre><code class="java">Countly.sharedInstance().changeDeviceId("new device ID")</code></pre>
<p>
  Whenever your authenticated user logs out, but you want to track history and
  further activity under another Countly user, you would call:
</p>
...
<div class="callout callout--danger">
  ...
  <p>
    In order to use push notifications for Android, you'll need to add Firebase
    to your dependencies yourself.
  </p>
</div>
<p>Countly SDK suports only FCM notifications.</p>
<h2>Getting FCM credentials</h2>
<p>Countly needs server key to authenticate with FCM.</p>
<p>
...
<p>
  Copy &amp; paste FCM key into your application FCM credentials upload form in
  Countly dashboard, hit Validate and eventually save changes.
</p>
<div class="img-container">
  <img src="https://count.ly/images/guide/703de0a-Screenshot-2018-04-21-17.30.59-x.png">
</div>
<h2>FCM integration</h2>
<p>
  Please check our
...
<p>
  <strong>Custom notification sound</strong>
</p>
<div class="callout callout--warning">
  <h3 class="callout__title">Custom sound</h3>
  <p>
    If you want to use a custom sound in your push notifications, they have to
    be present on the device. They can't be stored somewhere on the internet
...
<p>
  First you need to prepare the URI that will link to the resource on your device,
...
<p>
  You would then send this URI as part of the push notification. This should cover
  devices with Android SDK &lt; 26.
</p>
<p>
  For devices with SDK version 26+ you also need to provide this URI during the
  notification channel setup. You would do something like this:
</p>
