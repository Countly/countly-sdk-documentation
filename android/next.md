...
<h2>
  <span style="font-weight: 400;">Direct Request</span>
</h2>
<p>
  <span style="font-weight: 400;">You may send a direct request to server with a custom key/value pairs of <code>Map&lt;String, String&gt;</code>. key/value pairs should be a simple string or stringify json. The simplest way to pass a stringify json is to create a <span>JSONObject/JSONArray and then call its .toString() to convert it to stringify json.</span><br></span>
</p>
