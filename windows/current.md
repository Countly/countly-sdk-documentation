...
<div>
  ...
  <ul>
    <li data-list-item-id="e631eeab74c9d063250f0c5e49b815ba6">.NET Standard 2.0</li>
    <li data-list-item-id="edb05d5b2ee6d56832ec024a87aa70a48">.NET Framework 3.5</li>
    <li data-list-item-id="e02b376f06a5213fd0dbd9c4725182857">.NET Framework 4.5</li>
  </ul>
</div>
<p>
...
<ol>
  <li data-list-item-id="e29296943f45490eb3c7a06e7573918dc">
  ...
  <li data-list-item-id="ed99e3133f78667213db7f281e74d4617">
  ...
  <li data-list-item-id="ec019931e2a3e0208180ae1af2fecfc0f">Accept any license prompts.</li>
</ol>
...
<pre><code class="language-csharp">//create the Countly init object
...
<pre><code class="language-csharp">Countly.SetCustomDataPath("C:\path\to\new\folder\");</code></pre>
...
<pre><code class="language-csharp">var cc = new CountlyConfig
{
...
<pre><code class="language-csharp hljs">Countly.IsLoggingEnabled = true;</code></pre>
...
<ul>
  <li data-list-item-id="e5c3b6a8ab3f5a20a0ebb78fae0ea6d72">Configuration: Debug</li>
  <li data-list-item-id="e8c396c6b6392aa90bff905ab3493fbf7">"Define DEBUG constant" is checked</li>
</ul>
<p>
...
<pre><code class="language-csharp">Dictionary&lt;string, string&gt; customInfo = new Dictionary&lt;string, string&gt;{
...
<pre><code class="language-csharp">Countly.RecordUnhandledException(ex.Message, ex.StackTrace);</code></pre>
...
<pre><code class="language-csharp">Countly.Instance.AddCrashBreadCrumb("breadcrumb");</code></pre>
...
<ul>
  <li data-list-item-id="ed1852579a9810fa9b9de11b791c4078a">
  ...
  <li data-list-item-id="e1777d850c3d128634e16a0b54404d9d8">
...
<pre><code class="language-csharp">Countly.RecordEvent("event-key");</code></pre>
<p>
...
<ul>
  <li data-list-item-id="e1f843a9b69db21eb49d7aed74764b48c">
    Usage 1: how many times <strong>purchase</strong> event occured.
  </li>
  <li data-list-item-id="e7003468682be50ebb50db06c9234c3d4">
    Usage 2: how many times <strong>purchase</strong> event occured + the total
    amount of those purchases.
  </li>
  <li data-list-item-id="ed526d8e49969f960b9ffcd1a449c0c1e">
  ...
  <li data-list-item-id="ecef1d12dfc7a9136a012cdb80445080d">
  ...
  <li data-list-item-id="e070d0f4b92f342dc7ff42e454e685ead">
...
<pre><code class="language-csharp">await Countly.RecordEvent("purchase", 3);</code></pre>
<p>
  <strong>2.</strong> <strong>Event key, count, and sum</strong>
</p>
<pre><code class="language-csharp">await Countly.RecordEvent("purchase", 3, 0.99);</code></pre>
<p>
  <strong>3. Event key and count with segmentation(s)</strong>
</p>
<pre><code class="language-csharp">Segmentation segmentation = new Segmentation();
...
<pre><code class="language-csharp">string eventName = "Some event";
...
<pre><code class="language-csharp">//end the event while providing segmentation information and count
...
<pre><code class="language-csharp">//start some event
Countly.Instance.StartEvent(eventName);
//wait some time
...
<pre><code class="language-csharp">//start the user session
...
<pre><code class="language-csharp">Countly.Instance.RecordView("Some View");</code></pre>
...
<ul>
  <li data-list-item-id="ebd788ea88ab36f5c30c2b22af45f5010">
  ...
  <li data-list-item-id="ebde5c55d89667e0c87d36d5bf29d4212">
...
<pre><code class="language-csharp">await Countly.Instance.SetId("new-device-id");</code></pre>
<p>
...
<ul>
  <li data-list-item-id="e40fc76501d3d6b45f5a7c7f744f847b0">
  ...
  <li data-list-item-id="e0a7c4b04294f320a2d20e4c227dd020c">
...
<pre><code class="language-csharp">string usedId = await Countly.GetDeviceId();</code></pre>
<p>SDK record the type of an id. These types are:</p>
<ul>
  <li data-list-item-id="e58e6e9142851b2c010ffb90e0446aae1">
    <code>DeveloperProvided</code>
  </li>
  <li data-list-item-id="ef7dbbfb8c426ca73ef7979f893e56ff2">
...
<pre><code class="language-csharp">var idType = Countly.Instance.GetDeviceIDType();</code></pre>
<p>
  You can use the DeviceIdType enums to evaluate the device ID type you retrieved:
</p>
<pre><code class="language-csharp">var idType = Countly.Instance.GetDeviceIDType();
...
<ul>
  <li data-list-item-id="eefa82426b227788c7a18be99330899d2">Country code (two-letter ISO standard).</li>
  <li data-list-item-id="ef1629b252de6b3eca7edc81d8694460b">City name (must be set together with the country code).</li>
  <li data-list-item-id="ee9cee4f43827f1ff2e150c9a9c88e531">
    Latitude and longitude values separated by a comma, e.g. "56.42345,123.45325".
  </li>
  <li data-list-item-id="e784ecaf08bf4dd580c11152555ce82ee">Your user’s IP address.</li>
</ul>
...
<p>For example:</p>
<pre><code class="language-csharp">//set user location
...
<pre><code class="language-csharp">//disable location tracking
...
<ul>
  <li data-list-item-id="e6224962a077450c861adec57952c5dff">
    <strong>Name</strong>: Full name of the user.
  </li>
  <li data-list-item-id="e0c97fb33b9197afe480df40bdb365b2b">
    <strong>Username</strong>: Username of the user.
  </li>
  <li data-list-item-id="e9d2e01ac7bda75f5b6949661cbba5da5">
    <strong>Email</strong>: Email address of the user.
  </li>
  <li data-list-item-id="e539ae33d1457ad27057d59bf6ff929a6">
    <strong>Organization</strong>: Organization the user is working in.
  </li>
  <li data-list-item-id="e0f6be09d2a90e1bf595c0e6c98c6de2e">
    <strong>Phone</strong>: Phone number.
  </li>
  <li data-list-item-id="e18e28e9a6cf77c42b1bb70c832db8dbd">
    <strong>Picture</strong>: Web-based Url for the user’s profile.
  </li>
  <li data-list-item-id="e8e0d35dc5e702245115112fb992903d8">
    <strong>Gender</strong>: Gender of the user (use only single char like ‘M’
    for Male and ‘F’ for Female).
  </li>
  <li data-list-item-id="e53fdbb7f4777e6f73fc6cf3b5a0fa381">
...
<p>Example:</p>
<pre><code class="language-csharp">// set name to John
...
<pre><code class="language-csharp">Countly.UserDetails.Custom.Add("city", "london");</code></pre>
...
<pre><code class="language-csharp">Countly.UserDetails.UploadUserPicture(picture_stream);</code></pre>
<p>
...
<ul>
  <li data-list-item-id="e11aee7b6b294e9f9ab2a9314a527a5d8">
    sessions - tracking when, how often and how long users use your app
  </li>
  <li data-list-item-id="e9c1e9affcdc5e1cd9e90e58c27f33f4b">events - allow sending events to the server</li>
  <li data-list-item-id="e16b8f48435869051d8a1060c45d10cb5">location - allow sending location information</li>
  <li data-list-item-id="e1b9c923d8bc38df627ba3c6e58f230cf">crashes - allow tracking crashes, exceptions, and errors</li>
  <li data-list-item-id="e8059bbe1c82b782a76727e4abc68d105">
...
<pre><code class="language-csharp">//preparing consent features
Dictionary&lt;ConsentFeatures, bool&gt; consent = new Dictionary&lt;ConsentFeatures, bool&gt;();
consent.Add(ConsentFeatures.Crashes, true);
consent.Add(ConsentFeatures.Events, false);
consent.Add(ConsentFeatures.Location, true);
...
<pre><code class="language-csharp">CountlyConfig cc = new CountlyConfig();
cc.serverUrl = "COUNTLY_SERVER_URL";
cc.appKey = "COUNTLY_APP_KEY";
...
<pre><code class="language-csharp">Dictionary&lt;string, string&gt; customHeaderValues = new Dictionary&lt;string, string&gt;();
...
<div>
  <pre><code class="language-csharp">IDictionary&lt;string, string&gt; metricOverride = new Dictionary&lt;string, string&gt;();
...
<pre><code class="language-csharp">Countly.Instance.BackendMode().RecordException(DEVICE_ID, "Exception");</code></pre>
<p>
...
<pre><code class="language-csharp">"_os", "_os_version", "_ram_total", "_ram_current", "_disk_total", "_disk_current", "_online", "_muted", "_resolution", "_app_version", "_manufacture", "_device", "_orientation", "_run"</code></pre>
<p>Optional values:</p>
<p>
...
<pre><code class="language-csharp">// unhandled crash reporting with metrics
...
<pre><code class="language-csharp">Countly.Instance.BackendMode().RecordEvent(string deviceId, string eventKey, Segmentation segmentations = null, int count = 1, double? sum = null, long? duration = null, string appKey = null, long timestamp = 0);</code></pre>
<p>
  Here are some examples for recording event with the backend mode:
</p>
<pre><code class="language-csharp">BackendMode bm = Countly.Instance.BackendMode(); // for convenient calling
...
<pre><code class="language-csharp">Countly.Instance.BackendMode().BeginSession(string deviceId, string appKey = null, IDictionary&lt;string, string&gt; metrics = null, IDictionary&lt;string, string&gt; location = null, long timestamp = 0);</code></pre>
<p>
...
<pre><code class="language-csharp">// minimal call to the BeginSession, this fallbacks to internal metrics and app key
...
<pre><code class="language-csharp">Countly.Instance.BackendMode().UpdateSession(string deviceId, int duration, string appKey = null, long timestamp = 0);</code></pre>
<p>Here are examples about UpdateSession method.</p>
<pre><code class="language-csharp">// minimal call to the UpdateSession, this fallbacks to internal metrics and app key
...
<pre><code class="language-csharp">Countly.Instance.BackendMode().EndSession(string deviceId, int duration, string appKey = null, long timestamp = 0);</code></pre>
<p>Here are examples about EndSession method.</p>
<pre><code class="language-csharp">// minimal call to the EndSession, this fallbacks to internal metrics and app key
...
<pre><code class="language-csharp">Countly.Instance.BackendMode().StartView(string deviceId, string name, Segmentation segmentations = null, string segment = null, string appKey = null, bool firstView = false, long timestamp = 0);</code></pre>
<p>
...
<pre><code class="language-csharp">// minimal call to the StartView
...
<pre><code class="language-csharp">Countly.Instance.BackendMode().StopView(string deviceId, string name, long duration, Segmentation segmentations = null, string segment = null, string appKey = null, long timestamp = 0);</code></pre>
<p>
...
<pre><code class="language-csharp">// minimal call to the StopView
...
<pre><code class="language-csharp">Countly.Instance.BackendMode().ChangeDeviceIdWithMerge(string newDeviceId, string oldDeviceId, string appKey = null, long timestamp = 0);</code></pre>
<p>newDeviceId is required, should not be empty or null</p>
<p>Here are examples about ChangeDeviceIdWithMerge method.</p>
<pre><code class="language-csharp">// minimal call to the ChangeDeviceIdWithMerge, this fallbacks to internal app key
...
<pre><code class="language-csharp">Countly.Instance.BackendMode().RecordUserProperties(string deviceId, IDictionary&lt;string, object&gt; userProperties, string appKey = null, long timestamp = 0);</code></pre>
<p>
...
<pre><code class="language-csharp">"name", "username", "email", "organization", "phone", "gender", "byear", "picture"</code></pre>
<p>
...
<pre><code class="language-csharp">// minimal call to the RecordUserProperties, this fallbacks to internal app key
...
<pre><code class="language-csharp">Countly.Instance.BackendMode().RecordDirectRequest(string deviceId, IDictionary&lt;string, string&gt; paramaters, string appKey = null, long timestamp = 0);</code></pre>
...
<pre><code class="language-csharp">// minimal call to the RecordDirectRequest, this fallbacks to internal app key
...
<pre><code class="language-csharp">cc.SetMaxRequestQueueSize(1000); // sets request queue max size as 1000
...
<pre><code class="language-csharp">AppDomain.CurrentDomain.UnhandledException += async (sender, args) =&gt; {
...
<pre><code class="language-csharp">TaskScheduler.UnobservedTaskException += async (sender, args) =&gt; {
...
<pre><code class="language-csharp">Android.Runtime.AndroidEnvironment.UnhandledExceptionRaiser += async (sender, args) =&gt; {
  args.Handled = true;
  await Countly.RecordException(args.Exception.Message, args.Exception.StackTrace, null, true); 
};</code></pre>
...
<pre><code class="language-csharp">ObjCRuntime.Runtime.MarshalManagedException += async (_, args) =&gt; {
...
<pre><code class="language-csharp">Countly.Instance.ChangeDeviceId("new-device-id", true);</code></pre>
<p>
...
<pre><code class="language-csharp">Countly.Instance.ChangeDeviceId("new-device-id", false);</code></pre>
<p>
...
<pre><code class="language-csharp">ServicePointManager.SecurityProtocol = (SecurityProtocolType)3072;</code></pre>
<p>
