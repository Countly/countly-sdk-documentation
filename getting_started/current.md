...
<p>
  ...
  to the app, device, platform, and platform.&nbsp;
</p>
<p>
...
<p>
  ...
  you will change the device ID with merging. You
  would change the device ID without merging on any follow-up logins. This way, you can assign the events
...
<p>
  ...
  all three worlds, the goal is to track the user's lifecycle across all
  of them.
</p>
<p>
...
<p>
  ...
  and those that you should be paying attention to ("22.02.X").&nbsp;
</p>
