...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">#import "Countly.h"
...
<pre><code class="language-plaintext">iOS
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.enableDebug = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.enableDebug = true</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.loggerDelegate = self; //or any other object to act as CountlyLoggerDelegate</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.loggerDelegate = self //or any other object to act as CountlyLoggerDelegate</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">// CountlyLoggerDelegate protocol method
- (void)internalLog:(NSString *)log
{
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">// CountlyLoggerDelegate protocol method
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.features = @[CLYCrashReporting];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.features = [CLYCrashReporting]</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">NSException* myException = [NSException exceptionWithName:@"MyException" reason:@"MyReason" userInfo:@{@"key":@"value"}];

[Countly.sharedInstance recordException:myException];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">let myException : NSException = NSException.init(name:NSExceptionName(rawValue: "MyException"), reason:"MyReason", userInfo:["key":"value"])
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance recordError:@"ERROR_NAME" stackTrace:[NSThread callStackSymbols]];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().recordError("ERROR_NAME", stackTrace: Thread.callStackSymbols)
</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">NSDictionary* segmentation = @{@"country":@"Germany", @"app_version":@"1.0", @"arrayKey": @[@"one", @2, @3.14], @"int": @5, @"bool": @YES, @"double": @3.14, @"intArr": @[@4, @5, @6]};
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance recordCrashLog:@"This is a custom crash log."];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().recordCrashLog("This is a custom crash log.")</code></pre>
  </div>
</div>
<p>
...
<pre><code class="language-plaintext">- Exception Info:
  * Exception Name
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.crashSegmentation = @{@"key": @"value", @"arrayKey": @[@"one", @2, @3.14], @"int": @5, @"bool": @YES, @"double": @3.14, @"intArr": @[@4, @5, @6]};</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.crashSegmentation = ["key": "value", "arrayKey": ["one", 2, 3.14], "int": 5, "bool": true, "double": 3.14, "intArr": [4, 5, 6]]</code></pre>
  </div>
</div>
...
<pre><code class="language-objectivec">@interface CountlyCrashData : NSObject
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">import Countly
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.shouldUsePLCrashReporter = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.shouldUsePLCrashReporter = true</code></pre>
    <pre><span style="background-color: #ffffff;"><span style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif;"> </span></span></pre>
  </div>
</div>
<p>
...
<pre><code class="language-bash">post_install do |installer|
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.shouldUseMachSignalHandler = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.shouldUseMachSignalHandler = true</code></pre>
    <pre><span style="background-color: #ffffff;"><span style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif;"> </span></span></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.crashOccuredOnPreviousSessionCallback = ^(NSDictionary * crashReport)
{  
  NSLog(@"crash report: %@", crashReport);
};</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.crashOccuredOnPreviousSessionCallback =
{
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.shouldSendCrashReportCallback = ^(NSDictionary * crashReport)
{                                                                                                                              NSLog(@"crash report: %@", crashReport);
  return YES;    //NO;
};</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.shouldSendCrashReportCallback =
{
  (crashReport: [AnyHashable: Any]) in print("crash report: \(crashReport)")
  return true    //false
}</code></pre>
...
<pre><code class="language-shell">COUNTLY_DSYM_UPLOADER=$(/usr/bin/find $SRCROOT -name "countly_dsym_uploader.sh" | head -n 1)
...
<pre><code class="language-shell">${DWARF_DSYM_FOLDER_PATH}/${DWARF_DSYM_FILE_NAME}/Contents/Resources/DWARF/${PRODUCT_NAME}</code></pre>
<p>
...
<pre><code class="language-plaintext">YourAppName                               0x000000010006e174 YourAppName + 156020
...
<pre><code class="language-plaintext">-[MHViewController countlyProductionTest] (in YourAppName) (MHViewController.m:620)
...
<ul>
  <li data-list-item-id="e3d43d7cd1119c4a5d42b626aa2fbbac9">
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance recordEvent:@"purchase"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().recordEvent("purchase")</code></pre>
  </div>
</div>
<ul>
  <li data-list-item-id="e889a8690d9df5c9a6a1721dd2c56c956">
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance recordEvent:@"purchase" count:3];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().recordEvent("purchase", count:3)</code></pre>
  </div>
</div>
<ul>
  <li data-list-item-id="e398664fe405e1486a88bb6e4eadce5fe">
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance recordEvent:@"purchase" sum:3.33];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().recordEvent("purchase", sum:3.33)</code></pre>
  </div>
</div>
<ul>
  <li data-list-item-id="e54f3695b24fe827e3421c639a68fd72c">
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance recordEvent:@"purchase" count:3 sum:9.99];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().recordEvent("purchase", count:3, sum:3.33)</code></pre>
  </div>
</div>
<ul>
  <li data-list-item-id="efbd1ca0d08bd6d99f7071f19b105e967">
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">NSDictionary* dict = @{@"country":@"Germany", @"app_version":@"1.0", @"arrayKey": @[@"one", @2, @3.14], @"int": @5, @"bool": @YES, @"double": @3.14, @"intArr": @[@4, @5, @6]};

[Countly.sharedInstance recordEvent:@"purchase" segmentation:dict];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">let dict : Dictionary&lt;String, Any&gt; = ["country":"Germany", "app_version":"1.0", "arrayKey": ["one", 2, 3.14], "int": 5, "bool": true, "double": 3.14, "intArr": [4, 5, 6]]

Countly.sharedInstance().recordEvent("purchase", segmentation:dict)</code></pre>
  </div>
</div>
<ul>
  <li data-list-item-id="e2f472f6743fc6f46d8d173bc6d2ddf4e">
...
<ul>
  <li data-list-item-id="e23c5e5e38b015b1e17bb19f43eea5d9b">
...
<ul>
  <li data-list-item-id="e9635e5be4fdc4a7ba1e4e941ab9af648">
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance startEvent:@"level24"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().startEvent("level24")</code></pre>
  </div>
</div>
<ul>
  <li data-list-item-id="e19cdf3ce6238ea9cc7bf064a576318a5">
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance endEvent:@"level24"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().endEvent("level24")</code></pre>
  </div>
</div>
<p>
...
<ul>
  <li data-list-item-id="e639c81b4892f1bb32a95ddd023c42a08">
...
<div class="tabs">
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance cancelEvent:@"level24"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().cancelEvent("level24")</code></pre>
  </div>
</div>
<p>
...
<ul>
  <li data-list-item-id="e3495e9828fcd666a67b364f019e21561">
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance recordEvent:@"level24" duration:344];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().recordEvent("level24", duration:344)</code></pre>
  </div>
</div>
<p>
...
<ul>
  <li data-list-item-id="eed06dad19825132cd957f5d9c75859cd">
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.manualSessionHandling = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.manualSessionHandling = true</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance beginSession];
[Countly.sharedInstance updateSession];
[Countly.sharedInstance endSession];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().beginSession()
Countly.sharedInstance().updateSession()
Countly.sharedInstance().endSession()</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.updateSessionPeriod = 300;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.updateSessionPeriod = 300</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.enableAutomaticViewTracking = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.enableAutomaticViewTracking = true</code></pre>
  </div>
</div>
<p>
...
<pre><code class="language-plaintext">UINavigationController
UIAlertController
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.automaticViewTrackingExclusionList = @[NSStringFromClass(MyViewController.class), @"MyViewControllerName"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-objectivec">config.automaticViewTrackingExclusionList = [NSStringFromClass(MyViewController.class), "MyViewControllerName"];</code></pre>
  </div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">//Make your view controller to conform CountlyAutoViewTrackingName protocol.
...
- (NSString *)countlyAutoViewTrackingName { return @"This is overridden custom view name"; }</code></pre>
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">//Make your view controller to conform CountlyAutoViewTrackingName protocol. 
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.views startAutoStoppedView:@"MyView"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().views.startAutoStoppedView("MyView")</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.views startAutoStoppedView:@"MyView" segmentation:@{@"key": @"value", @"arrayKey": @[@"one", @2, @3.14], @"int": @5, @"bool": @YES, @"double": @3.14, @"intArr": @[@4, @5, @6]}];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().views.startAutoStoppedView("MyView", segmentation: ["key": "value", "arrayKey": ["one", 2, 3.14], "int": 5, "bool": true, "double": 3.14, "intArr": [4, 5, 6]])</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.views startView:@"MyView"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().views.startView("MyView")</code></pre>
  </div>
</div>
<p>
  <span style="font-weight: 400;">You can also specify the custom segmentation key-value pairs while starting views:</span>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.views startView:@"MyView" segmentation:@{@"key": @"value", @"arrayKey": @[@"one", @2, @3.14], @"int": @5, @"bool": @YES, @"double": @3.14, @"intArr": @[@4, @5, @6]}];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().views.startView("MyView", segmentation: ["key": "value", "arrayKey": ["one", 2, 3.14], "int": 5, "bool": true, "double": 3.14, "intArr": [4, 5, 6]])</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.views stopViewWithName:@"MyView"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().views.stopViewWithName("MyView")</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.views stopViewWithName:@"MyView" segmentation:@{@"key": @"value", @"arrayKey": @[@"one", @2, @3.14], @"int": @5, @"bool": @YES, @"double": @3.14, @"intArr": @[@4, @5, @6]}];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().views.stopViewWithName("MyView", segmentation: ["key": "value", "arrayKey": ["one", 2, 3.14], "int": 5, "bool": true, "double": 3.14, "intArr": [4, 5, 6]])</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.views stopViewWithID:@"VIEW_ID"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().views.stopViewWithID("VIEW_ID")</code></pre>
  </div>
</div>
<p>
  This function allows you to manually stop the tracking of a view identified by
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.views stopViewWithID:@"VIEW_ID" segmentation:@{@"key": @"value", @"arrayKey": @[@"one", @2, @3.14], @"int": @5, @"bool": @YES, @"double": @3.14, @"intArr": @[@4, @5, @6]}];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().views.stopViewWithID("VIEW_ID", segmentation: ["key": "value", "arrayKey": ["one", 2, 3.14], "int": 5, "bool": true, "double": 3.14, "intArr": [4, 5, 6]])</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.views stopAllViews:@{@"key": @"value"}];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().views.stopAllViews(["key": "value"])</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.views pauseViewWithID:@"VIEW_ID"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().views.pauseViewWithID("VIEW_ID")</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.views resumeViewWithID:@"VIEW_ID"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().views.resumeViewWithID("VIEW_ID")</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">NSString * viewID = [Countly.sharedInstance.views startView:@"VIEW_NAME"];
...
[Countly.sharedInstance.views addSegmentationToViewWithName:@"VIEW_NAME" segmentation:@{@"key": @"value", @"arrayKey": @[@"one", @2, @3.14], @"int": @5, @"bool": @YES, @"double": @3.14, @"intArr": @[@4, @5, @6]}];</code></pre>
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">let viewID = Countly.sharedInstance().views().startView("MyView");
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.views setGlobalViewSegmentation:@{@"key": @"value"}];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().views.setGlobalViewSegmentation(["key": "value"])</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.views updateGlobalViewSegmentation:@{@"key": @"value", @"arrayKey": @[@"one", @2, @3.14], @"int": @5, @"bool": @YES, @"double": @3.14, @"intArr": @[@4, @5, @6]}];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().views.updateGlobalViewSegmentation(["key": "value", "arrayKey": ["one", 2, 3.14], "int": 5, "bool": true, "double": 3.14, "intArr": [4, 5, 6]])</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.deviceID = @"customDeviceID";  //Optional custom device ID</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.deviceID = "customDeviceID"  //Optional custom device ID</code></pre>
  </div>
</div>
<p>
  <strong>Note:</strong>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">//Automatically handle whether to merge the device ID or not.
[Countly.sharedInstance setID:@"new_device_id"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">//Automatically handle whether to merge the device ID or not.
Countly.sharedInstance().setID("new_device_id")</code></pre>
  </div>
</div>
<div class="callout callout--warning">
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[config enableTemporaryDeviceIDMode];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.enableTemporaryDeviceIDMode();</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance enableTemporaryDeviceIDMode];
</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().enableTemporaryDeviceIDMode()</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance setID:@"new_device_id"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().setID("new_device_id")</code></pre>
  </div>
</div>
<div class="callout callout--warning">
  <p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance deviceID];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().deviceID()</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance deviceIDType];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().deviceIDType()</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.resetStoredDeviceID = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.resetStoredDeviceID = true</code></pre>
  </div>
</div>
<p>
...
<p>
  <span style="font-weight: 400;"><strong>First, you will need to acquire Push Notification credentials from Apple. (If you don't have them you can check </strong></span><a href="/hc/en-us/articles/360037753511#h_01HNF5NPFR0W8WJ1BW8WVXJ5AB"><span style="font-weight: 400;"><strong>this</strong></span></a><span style="font-weight: 400;"><strong> article to learn how you can do it.)</strong></span>
</p>
<p>
  <span style="font-weight: 400;">Then you would need to upload these credential to your Countly server. You can refer to </span><a href="/hc/en-us/articles/360037753511#h_01HNF5QRPJGG0GKMMH2SZWVK85"><span style="font-weight: 400;">this</span></a><span style="font-weight: 400;"> article for learning how you can do that.</span>
</p>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">- (BOOL)application:(UIApplication *)app openURL:(NSURL *)url options:(NSDictionary&lt;UIApplicationOpenURLOptionsKey, id&gt; *)options
{
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">- (BOOL)application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(nullable NSString *)sourceApplication annotation:(id)annotation
{
  //handle URL here to navigate to custom views
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">func application(_ application: UIApplication, open url: URL, sourceApplication: String?, annotation: Any) -&gt; Bool
{
  //handle URL here to navigate to custom views
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">if ([url.scheme isEqualToString: @"countly"])
{
 ...
 // or you can use host property directly
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">if (url.scheme == "countly")
{
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">#import "CountlyNotificationService.h"</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">// No need to import files for Swift projects</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">- (void)didReceiveNotificationRequest:(UNNotificationRequest *)request withContentHandler:(void (^)(UNNotificationContent * _Nonnull))contentHandler
{
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">override func didReceive(_ request: UNNotificationRequest, withContentHandler contentHandler: @escaping (UNNotificationContent) -&gt; Void)
{
  self.contentHandler = contentHandler
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">UNAuthorizationOptions authorizationOptions = UNAuthorizationOptionProvisional;
...
[Countly.sharedInstance askForNotificationPermissionWithOptions:authorizationOptions completionHandler:^(BOOL granted, NSError *error)
{
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">let authorizationOptions : UNAuthorizationOptions = [.provisional]
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.pushTestMode = CLYPushTestModeDevelopment;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.pushTestMode = CLYPushTestModeDevelopment</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.pushTestMode = CLYPushTestModeTestFlightOrAdHoc;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.pushTestMode = CLYPushTestModeTestFlightOrAdHoc</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.doNotShowAlertForNotifications = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.doNotShowAlertForNotifications = true</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">NSDictionary* userInfo;     // notification dictionary
...
[Countly.sharedInstance recordActionForNotification:userInfo clickedButtonIndex:buttonIndex];
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">let userInfo : Dictionary&lt;String, AnyObject&gt; = Dictionary() // notification dictionary
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.sendPushTokenAlways = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.sendPushTokenAlways = true</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">UNAuthorizationOptions authorizationOptions = UNAuthorizationOptionBadge | UNAuthorizationOptionSound | UNAuthorizationOptionAlert;
...
[Countly.sharedInstance askForNotificationPermissionWithOptions:authorizationOptions completionHandler:^(BOOL granted, NSError *error)
{
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">let authorizationOptions : UNAuthorizationOptions = [.badge, .alert, .sound]
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.launchNotification = notification;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.launchNotification = notification</code></pre>
  </div>
</div>
...
<ul>
  <li data-list-item-id="ebf6f60dbd41da1f89662bfd2f372e0a5">APNs Auth Key (preferred method)</li>
  <li data-list-item-id="e971286bad002d3ad036a2531167d1662">Universal (Sandbox + Production) Certificate</li>
</ul>
...
<ul>
  <li data-list-item-id="e0bad21070afbef83db4b01a3544f0ed2">
  ...
  <li data-list-item-id="ec34d17f0286554aa29cba72bb60a0cd5">
    <code>Team ID</code> (see
    <a href="https://developer.apple.com/account/#/membership/">Membership</a>
    section)
  </li>
  <li data-list-item-id="e5de0c38d01f9d4d8441d45e166b5295b">
...
<ul>
  <li data-list-item-id="ebdf56507637671846279f4bd7815ec14">
    <code>location</code>: a CLLocationCoordinate2D struct specifying latitude
    and longitude
  </li>
  <li data-list-item-id="ed9ed0422adac24be97c011f5b3f6c568">
    <code>ISOCountryCode</code> an NSString in ISO 3166-1 alpha-2 format country
    code
  </li>
  <li data-list-item-id="ed65810ee35d21e53436dff9f0b904836">
    <code>city</code> an NSString specifying city name
  </li>
  <li data-list-item-id="eac382600f83e56231d630c4b804fe7fa">
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.location = (CLLocationCoordinate2D){35.6895,139.6917};
...
config.IP = @"255.255.255.255"</code></pre>
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.location = CLLocationCoordinate2D(latitude:35.6895, longitude: 139.6917)
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance recordLocation:(CLLocationCoordinate2D){35.6895,139.6917} city:@"Tokyo" ISOCountryCode:@"JP" IP:@"255.255.255.255"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().recordLocation(CLLocationCoordinate2D(latitude:33.6895, longitude:139.6917), city:"Tokyo", ISOCountryCode:"JP", IP:"255.255.255.255");</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.disableLocation = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.disableLocation = true</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance disableLocationInfo];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().disableLocationInfo;</code></pre>
  </div>
</div>
<p>
...
<div>
  ...
  <ul>
    <li data-list-item-id="e3175d4d81f9b48079cd6ae84683d07ca">
      <span style="font-weight: 400;">when the SDK has finished initializing</span>
    </li>
    <li data-list-item-id="eb613d268e98aad539043064d451e3451">
      <span style="font-weight: 400;">after the device ID is changed without merging</span>
    </li>
    <li data-list-item-id="ef4066a2de1e6435cea191dfcddaa3929">
      <span style="font-weight: 400;">when user gets out of temp ID mode</span>
    </li>
    <li data-list-item-id="eaf10019d4a36b9289822762ef773608d">
  ...
  <div class="tabs">
    ...
    <div class="tab">
      <pre><code class="language-objectivec">config.enableRemoteConfigAutomaticTriggers = YES;
</code></pre>
    </div>
    <div class="tab is-hidden">
      <pre><code class="language-swift">config.enableRemoteConfigAutomaticTriggers = true</code></pre>
    </div>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.enableRemoteConfigValueCaching = YES;
</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.enableRemoteConfigValueCaching = true</code></pre>
  </div>
</div>
...
<ul>
  <li data-list-item-id="ef563275429672ddd04a153e5a6453809">
    <span style="font-weight: 400;">Manually downloading all keys</span>
  </li>
  <li data-list-item-id="e6b828b6cee5f4fcc47467ca54cc58e6b">
    <span style="font-weight: 400;">Manually downloading specific keys</span>
  </li>
  <li data-list-item-id="e6a2a9b8eedd22fa78e7db6731b326f61">Manually downloading, omitting (everything except) keys.</li>
</ul>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.remoteConfig downloadKeys:^(CLYRequestResult _Nonnull response, NSError * _Nonnull error, BOOL fullValueUpdate, NSDictionary&lt;NSString *,CountlyRCData *&gt; * _Nonnull downloadedValues) {
   //...
}];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().remoteConfig.downloadKeys { response, error, fullValueUpdate, downloadedValues in
   //...
}
</code></pre>
  </div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.remoteConfig downloadSpecificKeys:NSArray *keys completionHandler:^(CLYRequestResult _Nonnull response, NSError * _Nonnull error, BOOL fullValueUpdate, NSDictionary&lt;NSString *,CountlyRCData *&gt; * _Nonnull downloadedValues) {
   //...
}];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().remoteConfig.downloadSpecificKeys(keys, completionHandler: { response, error, fullValueUpdate, downloadedValues in
   //...
})
</code></pre>
  </div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.remoteConfig downloadOmittingKeys:NSArray *omitKeys completionHandler:^(CLYRequestResult _Nonnull response, NSError * _Nonnull error, BOOL fullValueUpdate, NSDictionary&lt;NSString *,CountlyRCData *&gt; * _Nonnull downloadedValues) {
   //...
}];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance.remoteConfig.downloadOmittingKeys(omitKeys, completionHandler: { response, error, fullValueUpdate, downloadedValues in
   //...
})
</code></pre>
  </div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">id value_1 = [Countly.sharedInstance.remoteConfig getValue:@"key_1"].value;
...
NSDictionary *jObj = [value_4 isKindOfClass:[NSDictionary class]] ? (NSDictionary*)value_4 : @{};</code></pre>
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">let value_1 = Countly.sharedInstance().remoteConfig.getValue("key_1")?.value
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">NSDictionary&lt;NSString*, CountlyRCData*&gt; *allValues = [Countly.sharedInstance.remoteConfig getAllValues];
...
NSDictionary*jObj = (NSDictionary *)allValues[@"key_4"];</code></pre>
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">let allValues = Countly.sharedInstance().remoteConfig.getAllValues()
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">@interface CountlyRCData : NSObject
...
@end
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">class CountlyRCData {
  var value: Any
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.remoteConfig clearAll];
</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().remoteConfig.clearAll()
</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[config remoteConfigRegisterGlobalCallback:^(CLYRequestResult _Nonnull response, NSError * _Nonnull error, BOOL fullValueUpdate, NSDictionary&lt;NSString *,CountlyRCData *&gt; * _Nonnull downloadedValues) {
    // ...
}]
</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.remoteConfigRegisterGlobalCallback { response, error, fullValueUpdate, downloadedValues in
    // ...
}</code></pre>
  </div>
</div>
...
<ul>
  <li data-list-item-id="ebf56336cb00930886cf9c10bd273d08f">
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">typedef void (^RCDownloadCallback)(CLYRequestResult response, NSError *_Nullable error, BOOL fullValueUpdate, NSDictionary&lt;NSString*, CountlyRCData *&gt;* downloadedValues);
</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">typealias RCDownloadCallback = (CLYRequestResult, Error?, Bool, [String: CountlyRCData]?) -&gt; Void
</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">// register a callback
...
[Countly.sharedInstance.remoteConfig removeDownloadCallback:^(CLYRequestResult _Nonnull response, NSError *_Nonnull error, BOOL fullValueUpdate, NSDictionary&lt;NSString *,CountlyRCData*&gt; * _Nonnull downloadedValues) {
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">// register a callback
...
<div>
  ...
  <pre><code class="language-objectivec">config.enrollABOnRCDownload= YES;</code></pre>
  <div>
    <div>
      ...
      <div>
        <div>
          ...
          <div class="tabs">
            ...
            <div class="tab">
              <pre><code class="language-objectivec">[Countly.sharedInstance.remoteConfig enrollIntoABTestsForKeys:NSArray *keys];
</code></pre>
            </div>
            <div class="tab is-hidden">
              <pre><code class="language-swift">Countly.sharedInstance().remoteConfig.enrollIntoABTests(forKeys: keys as [String])
</code></pre>
            </div>
          </div>
          <p>
          ...
          <div>
            <div>
              ...
              <div class="tabs">
                ...
                <div class="tab">
                  <pre><code class="language-objectivec">[Countly.sharedInstance.remoteConfig exitABTestsForKeys:NSArray *keys];
</code></pre>
                </div>
                <div class="tab is-hidden">
                  <pre><code class="language-swift">Countly.sharedInstance().remoteConfig.exitABTestsForKeys(forKeys: keys as [String])
</code></pre>
                </div>
              </div>
              <p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.starRatingSessionCount = 10;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.starRatingSessionCount = 10</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.starRatingDisableAskingForEachAppVersion = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.starRatingDisableAskingForEachAppVersion = true</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.starRatingMessage = @"Please rate our app?";</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.starRatingMessage = "Please rate our app?"
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.starRatingCompletion = ^(NSInteger rating)
{
  NSLog(@"rating %d",(int)rating);
};</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.starRatingCompletion = { (rating : Int) in print("rating \(rating)") }</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance askForStarRating:^(NSInteger rating)
{
  NSLog(@"rating %li",(long)rating);
}];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().ask(forStarRating:{ (rating : Int) in print("rating \(rating)") })</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance feedback];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().feedback()</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[presentNPS]
[presentSurvey]
[presentRating]
// Example:
[Countly.sharedInstance.feedback presentNPS];
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">.presentNPS()
.presentSurvey()
.presentRating()
// Example:
Countly.sharedInstance().feedback().presentNPS()
...
<div class="tabs">
  <div class="tabs-menu">
    <div class="tabs">
      ...
      <div class="tab">
        <pre><code class="language-objectivec">[presentNPS:nameIDorTag
...
[Countly.sharedInstance.feedback presentNPS:@"/home-page"];
      ...
      <div class="tab is-hidden">
        <pre><code class="language-swift">.presentNPS(nameIDorTag)
.presentSurvey(nameIDorTag)
.presentRating(nameIDorTag)
// Example:
Countly.sharedInstance().feedback().presentNPS("/home-page")
...
<div class="tabs">
  <div class="tabs-menu">
    <div class="tabs">
      ...
      <div class="tab">
        <pre><code class="language-objectivec">[presentNPS:nameIDorTag widgetCallback:]
...
//...
      ...
      <div class="tab is-hidden">
        <pre><code class="language-swift">.presentNPS(nameIDorTag, widgetCallback)
.presentSurvey(nameIDorTag, widgetCallback)
.presentRating(nameIDorTag, widgetCallback)
// Example:
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">//default properties
...
[Countly.user save];</code></pre>
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">//default properties
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">//custom properties
...
[Countly.user save];</code></pre>
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">//custom properties
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.user set:@"key101" value:@"value101"];
...
[Countly.user save];</code></pre>
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.user().set("key101", value:"value101")
Countly.user().setOnce("key101", value:"value101")
Countly.user().unSet("key101")
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.enableOrientationTracking = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.enableOrientationTracking = true</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.apm.enableForegroundBackgroundTracking = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.apm().enableForegroundBackgroundTracking = true</code></pre>
  </div>
</div>
<p>
...
<p>
  ...
  <code class="objectivec">enableManualAppLoadedTrigger</code> on the initial configuration:
</p>
<div class="tabs">
  <div class="tabs-menu">
    <span class="tabs-link is-active">Objective-C</span>
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.apm.enableAppStartTimeTracking = YES;
config.apm.enableManualAppLoadedTrigger = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.apm().enableAppStartTimeTracking = true
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance appLoadingFinished];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().appLoadingFinished()</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">long long timestamp = floor(NSDate.date.timeIntervalSince1970 * 1000) - 500;
[config.apm setAppStartTimestampOverride:timestamp];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">long long timestamp = floor(NSDate.date.timeIntervalSince1970 * 1000) - 500;
config.apm().setAppStartTimestampOverride(timestamp)</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance recordNetworkTrace:@"/test/endpoint" requestPayloadSize:3445 responsePayloadSize:1290 responseStatusCode:200 startTime:1593418666954 endTime:1593418667384];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().recordNetworkTrace("/test/api", requestPayloadSize:3445, responsePayloadSize:1290, responseStatusCode:200, startTime:1593418666954, endTime:1593418667384)</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance startCustomTrace:@"unzipping_saved_files"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().startCustomTrace("unzipping_saved_files")</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance endCustomTrace:@"unzipping_saved_files" metrics:@{@"total_file_size": @1655700}];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().startCustomTrace("unzipping_saved_files", metrics:["total_file_size": 1655700])</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance cancelCustomTrace:@"unzipping_saved_files"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().cancelCustomTrace("unzipping_saved_files")</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  <div class="tabs-menu">
    <div class="tabs">
      ...
      <div class="tab">
        <pre><code class="language-objectivec">[Countly.sharedInstance clearAllCustomTraces];</code></pre>
      </div>
      <div class="tab is-hidden">
        <pre><code class="language-swift">Countly.sharedInstance().clearAllCustomTraces()</code></pre>
      </div>
    </div>
    <p>
...
<pre><code class="language-plaintext">CLYConsentSessions
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.requiresConsent = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.requiresConsent = true</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.consents = @[CLYConsentSessions, CLYConsentEvents];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-objectivec">config.consents = [CLYConsentSessions, CLYConsentEvents];</code></pre>
  </div>
...
<div class="tabs">
  <div class="tabs-menu">
    <div class="tabs">
      ...
      <div class="tab">
        <pre><code class="language-objectivec">config.enableAllConsents = YES;</code></pre>
      </div>
      <div class="tab is-hidden">
        <pre><code class="language-swift">config.enableAllConsents = true</code></pre>
      </div>
    </div>
    <div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance giveConsentForFeature:CLYConsentSessions];
[Countly.sharedInstance giveConsentForFeature:CLYConsentEvents];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().giveConsent(forFeature: CLYConsentSessions)
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance giveConsentForFeatures:@[CLYConsentSessions, CLYConsentEvents];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().giveConsent(forFeatures: [CLYConsentSessions, CLYConsentEvents])</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance giveAllConsents];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().giveAllConsents()</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance cancelConsentForFeature:CLYConsentSessions];
[Countly.sharedInstance cancelConsentForFeature:CLYConsentEvents];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().cancelConsent(forFeature: CLYConsentSessions)
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance cancelConsentForFeatures:@[CLYConsentSessions, CLYConsentEvents];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().cancelConsent(forFeatures: [CLYConsentSessions, CLYConsentEvents])</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance cancelConsentForAllFeatures];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().cancelConsentForAllFeatures()</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.secretSalt = @"mysecretsalt";</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.secretSalt = "mysecretsalt"</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.pinnedCertificates = @[@"mycertificate.cer"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.pinnedCertificates = ["mycertificate.cer"]</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.shouldIgnoreTrustCheck = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.shouldIgnoreTrustCheck = true</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance setNewAppKey:@"NewAppKey"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().setNewAppKey("NewAppKey")</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance replaceAllAppKeysInQueueWithCurrentAppKey];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().replaceAllAppKeysInQueueWithCurrentAppKey()</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance removeDifferentAppKeysFromQueue];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().removeDifferentAppKeysFromQueue()</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance setNewHost:@"https://example.com"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().setNewHost("https://example.com")</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.eventSendThreshold = 5;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.eventSendThreshold = 5</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.storedRequestsLimit = 5000;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.storedRequestsLimit = 5000</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.alwaysUsePOST = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.alwaysUsePOST = true</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.requestTimeoutDuration = 60;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.requestTimeoutDuration = 60</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.URLSessionConfiguration = NSURLSessionConfiguration.ephemeralSessionConfiguration;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.URLSessionConfiguration = URLSessionConfiguration.ephemeral</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance setNewURLSessionConfiguration:newURLSessionConfiguration];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().setNewURLSessionConfiguration(newURLSessionConfiguration)</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.customMetrics = @{@"key": @"value"};</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.customMetrics = ["key": "value"];</code></pre>
  </div>
</div>
<div class="tabs-menu">
  <p>
  ...
  <pre><code class="language-plaintext">CLYMetricKeyDevice
CLYMetricKeyOS
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.customMetrics = @{CLYMetricKeyAppVersion: @"1.2.3"};</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.customMetrics = [CLYMetricKeyAppVersion: "1.2.3"];</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[config.sdkInternalLimits setMaxKeyLength:150];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.sdkInternalLimits().setMaxKeyLength(150);</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[config.sdkInternalLimits setMaxValueSize:200];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.sdkInternalLimits().setMaxValueSize(200);</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[config.sdkInternalLimits setMaxSegmentationValues:120];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.sdkInternalLimits().setMaxSegmentationValues(120);</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[config.sdkInternalLimits setMaxBreadcrumbCount:120];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.sdkInternalLimits().setMaxBreadcrumbCount(120);</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[config.sdkInternalLimits setMaxStackTraceLinesPerThread:50];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.sdkInternalLimits().setMaxStackTraceLinesPerThread(50);</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[config.sdkInternalLimits setMaxStackTraceLineLength:300];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.sdkInternalLimits().setMaxStackTraceLineLength(300);</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.sdkBehaviorSettings = @"json server config";</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.sdkBehaviorSettings = "json server config";</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.disableSDKBehaviorSettingsUpdates = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.disableSDKBehaviorSettingsUpdates = true</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">NSString* campaignData = @"{\"keyA\":\"valueA\",\"keyB\":\"valueB\"}";
[Countly.sharedInstance recordDirectAttributionWithCampaignType:@"countly" andCampaignData:campaignData];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">let campaignData = "{\"keyA\":\"valueA\",\"keyB\":\"valueB\"}"
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance recordIndirectAttribution:@{CLYAttributionKeyADID: @"value", @"key1": @"value1", @"key2": @"value2"}];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().recordIndirectAttribution([CLYAttributionKey.ADID.rawValue: "value", "key1": "value1", "key2": "value2"])</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance attemptToSendStoredRequests];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().attemptToSendStoredRequests()</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance flushQueues];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().flushQueues()</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">CountlyConfig* config = CountlyConfig.new;
config.appKey = @"YOUR_APP_KEY";
config.host = @"https://YOUR_COUNTLY_SERVER";
...
[Countly.sharedInstance startWithConfig:config];</code></pre>
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">let config: CountlyConfig = CountlyConfig()
config.appKey = "YOUR_APP_KEY"
config.host = "https://YOUR_COUNTLY_SERVER"
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec" data-stringify-type="pre">- (void) sendDirectRequest {
...
- (NSString *) toString: (id) dictionaryOrArrayToOutput  {
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">func sendDirectRequest() {
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">NSMutableDictionary *metricsOverride = [NSMutableDictionary dictionary];
...
[Countly.sharedInstance recordMetrics:nil];</code></pre>
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">var metricsOverride = [String: String]()
metricsOverride["_app_version"] = "5.0"
metricsOverride["_os"] = "CustomOS"
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">#import "Countly.h"</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">// No need to import files for Swift projects</code></pre>
  </div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance suspend];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().suspend()</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance resume];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().resume()</code></pre>
  </div>
</div>
<p>
  <strong>9.</strong>
...
<ul>
  <li data-list-item-id="efb35ecde2089a2175708d04660f00b13">
  ...
  <li data-list-item-id="e088b1d5d1768d9794f0b4e05f58a403d">
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.updateSessionPeriod = 15;
config.eventSendThreshold = 1;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.updateSessionPeriod = 15
config.eventSendThreshold = 1</code></pre>
  </div>
</div>
...
<pre><code class="language-ruby">target 'MyMainApp' do
  platform :ios,'10.0'
  pod 'Countly'
end
...
<pre><code class="language-plaintext">github "Countly/countly-sdk-ios"</code></pre>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.content enterContentZone];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().content().enterContentZone();</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.content.zoneTimerInterval = 60;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-objectivec">config.content.zoneTimerInterval = 60</code></pre>
  </div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.content refreshContentZone];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().content().refreshContentZone();</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.content exitContentZone];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().content().exitContentZone();</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[config.content setGlobalContentCallback:^(ContentStatus contentStatus, NSDictionary&lt;NSString *,id&gt; * _Nonnull contentData) {
      // do sth
    }];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.content().setGlobalContentCallback { contentStatus, contentData in
      // do something
    }</code></pre>
  </div>
</div>
...
<ul>
  <li data-list-item-id="e17f3c48e334186b1a52c67f4d8a1a1ae">Previous Name Recording</li>
  <li data-list-item-id="e1af9ed89d7b5ee6cef285eb46dcc0420">Visibility Tracking</li>
</ul>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.experimental.enablePreviousNameRecording = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.experimental().enablePreviousNameRecording = true;</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.experimental.enableVisibiltyTracking = YES;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.experimental().enableVisibiltyTracking = true;</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.remoteConfig testingDownloadVariantInformation:^(CLYRequestResult _Nonnull response, NSError *_Nonnull error) {
   // do sth
}];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().remoteConfig.testingDownloadVariantInformation({ response, error in
   // do something
})</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">NSDictionary*allVariants = [Countly.sharedInstance.remoteConfig testingGetAllVariants];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">let allVariants = Countly.sharedInstance().remoteConfig.testingGetAllVariants()
</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">NSArray* variants = [Countly.sharedInstance.remoteConfig testingGetVariantsForKey:key];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">let variants = Countly.sharedInstance().remoteConfig.testingGetVariants(for: key) as NSArray
</code></pre>
  </div>
</div>
<p>
...
<pre><code class="language-json">["variant_1", "variant_2"]
</code></pre>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance.remoteConfig testingEnrollIntoVariant:key variantName:variantName completionHandler:^(CLYRequestResult _Nonnull response, NSError *_Nonnull error) {
   // do sth
}];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().remoteConfig.testingEnroll(intoVariant: key, variantName: variantName) { response, error in
   // do sth
}</code></pre>
  </div>
</div>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.setRequestDropAgeHours(10);</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.setRequestDropAgeHours(10)</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">//change and merge on server
...
[Countly.sharedInstance changeDeviceIDWithoutMerge:@"new_device_id"];</code></pre>
  ...
  <div class="tab is-hidden">
    <pre><code class="language-swift">//replace and merge on server
Countly.sharedInstance().changeDeviceIDWithMerge("new_device_id")
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">config.deviceID = CLYTemporaryDeviceID;</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">config.deviceID = CLYTemporaryDeviceID</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance changeDeviceIDWithoutMerge:CLYTemporaryDeviceID];
</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().changeDeviceIDWithoutMerge(CLYTemporaryDeviceID)</code></pre>
  </div>
</div>
<p>
...
<div class="tabs">
  ...
  <div class="tab">
    <pre><code class="language-objectivec">[Countly.sharedInstance changeDeviceIDWithMerge:@"new_device_id"];

[Countly.sharedInstance changeDeviceIDWithoutMerge:@"new_device_id"];</code></pre>
  </div>
  <div class="tab is-hidden">
    <pre><code class="language-swift">Countly.sharedInstance().changeDeviceIDWithMerge("new_device_id")
...
<p>
  ...
  is <code>CLYTemporaryDeviceID</code>, with merge or without merge does not matter.
</p>
...
<ul>
  <li class="ck-list-marker-color" data-list-item-id="ea8adf33cd12479ef7f6d85318e64919e">
  ...
  <li class="ck-list-marker-color" data-list-item-id="e0e2cbcfc89c0254c4dee27d54c7e0d6a">
  ...
  <li class="ck-list-marker-color" data-list-item-id="e64e1dee4b090967b35ec82584b9d5282">
  ...
  <li class="ck-list-marker-color" data-list-item-id="e34ffe6d67f428f6c8d243cf30e4b3135">
...
<ul>
  <li class="ck-list-marker-color" data-list-item-id="ea8a6e9f267cd5d87089fe1d0a2ea5fad">
...
<pre><code class="language-plaintext">http://mycountlyserver.com/i?app_key=0000000000000000000000000000000000000000
...
<ul>
  <li class="ck-list-marker-color" data-list-item-id="e1a0c75941fb6144f7c0c21e8c6ccb299">
...
<ul>
  <li class="ck-list-marker-color" data-list-item-id="e9348f6693aa67f3ba630f14d900beae6">
...
<ul>
  <li class="ck-list-marker-color" data-list-item-id="efb1bbee81db129af09c01594b86e2be1">
...
<ol>
  <li data-list-item-id="eee56f4157911775b240e9cf7a5ba44a9">
    You are setting
  ...
  <li data-list-item-id="edba8d3a30fad1465d1f3c46275423aeb">
  ...
  <li data-list-item-id="eda7171629f4d17998de2fa89b3550a9c">
