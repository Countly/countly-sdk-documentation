...
<pre><code class="java hljs">Countly.instance().events().recordEvent(<span class="hljs-string">"purchase", 1</span>);</code></pre>
<p>
  <strong>2. Event key, count, and sum</strong>
</p>
<pre><code class="java hljs">Countly.instance().events().recordEvent(<span class="hljs-string">"purchase", 1, 20.3);</span></code></pre>
<p>
...
Countly.instance().events().recordEvent(<span class="hljs-string">"purchase", 1, segmentation</span>);</code></pre>
<p>
...
Countly.instance().events().recordEvent(<span class="hljs-string">"purchase", 1, 34.5, segmentation</span>);<br></code></pre>
<p>
...
Countly.instance().events().recordEvent(<span class="hljs-string">"purchase", 1, 34.5, segmentation, 5.3</span>);<br></code></pre>
<p>
