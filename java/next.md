...
Countly.instance().crashes().recordUnhandledException(Throwable t);</code></pre>
<p>
...
<pre><code class="java">Countly.instance().crashes().recordHandledException(Throwable t, Map&lt;String, Object&gt; segment);
