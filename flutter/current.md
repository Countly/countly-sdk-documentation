...
<ul>
  ...
  <li>
    ...
    <code>segmentation</code> to track additional information. The only valid data types are: "String", "Integer", "Double" and "Boolean". All other types will be ignored
  </li>
</ul>
<div class="callout callout--info">
  <p class="callout__title">
...
<p>
  <code class="JavaScript">Countly.start();</code> will handle the start session, update session and end session automatically.<br>This is how it works:
</p>
<ul>
  <li>
    <strong>Start/Begin session Request:</strong> It is sent on <code class="JavaScript">Countly.start();</code> call and when the app comes back to the foreground from the background, and it includes basic metrics.
  </li>
  <li>
  ...
  <li>
    <strong>End Session Request:</strong> It is sent at the end of a session when the app goes to the background or terminates.
  </li>
</ul>
<p>
